...
main    proc
  ...
  ;  jmp exit
    ...
    push offset buffer4            ;
    push offset message            ;
    push offset buffer3            ; заменить все числа из строки, 
    push offset buffer1            ; содержащиеся в массиве, на слово "<number>",
...
task_msg db 'Replace in all lines of text the words that are numbers with the word "<number>"',10, 0
end main
